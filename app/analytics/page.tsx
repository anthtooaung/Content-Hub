          ...
          <EmptyState
            ...
            action={
              <button
                ...
                className="px-4 py-2 bg-primary text-white rounded-control transition-all hover:-translate-y-0.5 hover:bg-primary-600 hover:shadow-[0_4px_12px_rgba(37,99,235,0.3)]"
              >
                Generate Content
              </button>
            }
