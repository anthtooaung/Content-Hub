        ...
        <div className="w-full max-w-[380px]">
          ...
          <div className="mb-5">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 rounded-control border-2 border-border bg-surface px-4 py-2.5 text-[13px] font-semibold text-text-primary transition-all duration-150 hover:-translate-y-0.5 hover:border-primary-200 hover:bg-primary-50 hover:text-primary hover:shadow-[0_4px_12px_rgba(37,99,235,0.15)]"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="mb-1.5 block text-[13px] font-medium text-text-secondary">Confirm password</label>
              <div className="relative">
                <input
                  type={showPassword ? 'text' : 'password'}
                  ...
                  minLength={8}
                  className={clsx(
                    'h-[42px] w-full rounded-control border px-3.5 pr-10 text-sm outline-none transition-shadow focus:border-primary focus:shadow-focus',
              ...
              {confirmPassword && password !== confirmPassword && (
                <p className="mt-1 text-[12px] text-error">Passwords do not match</p>
              )}
            </div>
