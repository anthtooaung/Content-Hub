...
## Reference Points
- AI Content Studio UI Design System Handoff document
- Tailwind CSS component patterns
- Inter typeface with structured scale

## Sketches

| # | Name | Design Question | Winner | Tags |
|---|------|----------------|--------|------|
| 001 | landing-page | Does the hero and feature navigation feel like a calm, professional AI tool? | C | landing, hero, first-impression |
...
| 021 | profile-page | How should the profile page display user info, ticket balance, and reset timer? | B | profile, tickets, account, navigation |
| 022 | generate-ticket-flow | How should the generate page show ticket cost and low-ticket warnings? | B | generate, tickets, cost, warning, rate-limit |
