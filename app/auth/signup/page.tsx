      ...
      <div className="flex flex-1 items-center justify-center p-12 max-lg:p-8">
        <div className="w-full max-w-[380px]">
          ...
          <div className="flex gap-2.5 mb-5">
            <button className="flex-1 flex items-center justify-center gap-2 rounded-control border border-border bg-surface px-4 py-2.5 text-[13px] font-medium text-text-primary transition-all hover:bg-surface-subtle hover:border-border-strong">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="h-11 w-full rounded-control bg-primary text-sm font-semibold text-white transition-all hover:bg-primary-600 disabled:pointer-events-none disabled:opacity-70"
            >
              {loading ? (
