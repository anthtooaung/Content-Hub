...
# Sketch 019: TikTok Post Card

## Design Question
What does a pixel-perfect TikTok post card look like when displaying AI-generated content with/without user-uploaded images?

## How to View
open .planning/sketches/019-tiktok-post-card/index.html
...
## What to Look For
- Does the dark theme feel authentic to TikTok's UI?
- Is the "Add image" placeholder in Variant B clear without breaking the dark aesthetic?
- Does the compact view in Variant C work for a results list or dashboard?
- Are the sidebar icons, caption, and sound disc proportionally correct?
